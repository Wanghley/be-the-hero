...
export default function Detail(){
    ...
    const msg = `Olá ${incident.nome}, estou entrando em contato pois gostaria de ajudar no caso "${incident.titulo}" com o valor de ${Intl.NumberFormat('pt-BR',{style:'currency',currency:'BRL'}).format(incident.value)}`;
    ...
    function sendWhatsapp(){ //Deep Linking
